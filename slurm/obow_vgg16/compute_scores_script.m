function compute_scores_script(JOB_INDEX, LOD_ROOT, STEP, NUM_BLOCKS, DATASET_NAME, PROPSET_NAME)
  % NUM_BLOCKS: number of block S_{ij} to compute
  cd(LOD_ROOT)
  setup;
  START = JOB_INDEX*STEP-STEP+1;
  END = JOB_INDEX*STEP;
  script_aux(START, END, NUM_BLOCKS, DATASET_NAME, PROPSET_NAME, ...
             'CODE_ROOT', LOD_ROOT, 'DATA_ROOT',fullfile(LOD_ROOT, 'data'));
end


function script_aux(START, END , NUM_BLOCKS, DATASET_NAME, PROPSET_NAME, varargin)
%
...
%-------------------------------
deepfeat = true;
feat_type='vgg16_bn_obow80_relu53_77_roi_pooling_noresize';
sim_type = '01';
...
nb_type = {...
           'neighbor_cos_vgg16_bn_obow80_relu53_resize', ...
          };
indices_name = [];
